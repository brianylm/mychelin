...
- **Add a visual Cooking Card / timeline view for recipe reading:** a scaled-ingredient checklist plus a horizontal step timeline with heat/time chips, a prominent Start Cooking CTA into the existing Cook With Me session, and PNG / copy export for sharing in family chats. See work packet `docs/work-packets/cooking-card-timeline-view.md`.
