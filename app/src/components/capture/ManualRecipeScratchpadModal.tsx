...
export function ManualRecipeScratchpadModal({
  ...
  return (
    <div className="fixed inset-0 z-[70] bg-stone-950/45 px-4 py-5 backdrop-blur-sm sm:px-6">
      <div className="mx-auto flex h-full max-w-3xl flex-col overflow-hidden rounded-2xl border border-[#eadfce] bg-[#fffdfb] shadow-[0_28px_100px_rgba(35,24,18,0.28)]">
            ...
            <div className="grid gap-4">
              <label className="grid gap-2">
                ...
                <input
                  ...
                  className="h-12 rounded-xl border border-[#d9cfc2] bg-white px-4 text-base font-semibold text-stone-900 outline-none transition placeholder:text-stone-300 focus:border-[#800020]/45 focus:ring-2 focus:ring-[#800020]/10"
                  autoFocus
                />
              </label>
              ...
              <div className="flex flex-wrap items-center gap-2">
                <button
                  ...
                  className="rounded-full border border-[#eadfce] bg-white px-3 py-2 text-xs font-semibold text-stone-600 transition hover:border-[#800020]/25 hover:text-[#800020]"
                >
                  Use example
                </button>
        ...
        <footer className="flex flex-col gap-2 border-t border-[#eadfce] bg-white px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
          <button
            ...
            className="min-h-11 rounded-full px-4 text-sm font-semibold text-stone-500 transition hover:bg-stone-50 hover:text-stone-800"
          >
